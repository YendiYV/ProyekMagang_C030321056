...
?>
    <div>
        <table
            ...
            <tbody>
                <tr style="height: 113.575px;">
                    <img style="margin-top:20px; margin-right:-100px;  margin-left:-80px;" src="<?=base_url();?>assets/login/images/logo.jpg" alt="" height="95" />
                    <td style="width: 470px; text-align: center; height: 113.575px; border: none;">

                        <h4 style="text-align: center; margin-bottom:-20px;">PEMERINTAH PROVINSI KALIMANTAN SELATAN</h4>
                        ...
                        <h4 style="text-align: center; margin-bottom:-20px;">WILAYAH KALIMANTAN SELATAN</h4>
                        <h5 style="text-align: center; margin-bottom:10px;">Jl. Pangeran Hidayatullah No.22 Banjarbaru
                        </h5>
                    </td>
                    <td>
                    </td>
        ...
        <p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Bersama ini diterusakan usul cuti <?=$perihal_cuti?>
            operator Unit Pelayanan Pajak Provinsi
        ...
        <p style="text-align: justify">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Dikemukakan kepada Bapak/Ibu pada
            prinsipnya kami tidak berkeberatan atas usul cuti <?=$perihal_cuti?> operator tersebut, mengingat cuti
